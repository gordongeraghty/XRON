...
## 2026-06-10 - Empty State Recovery in Multi-select Components
**Learning:** In multi-select filter components (e.g., format toggles), leaving a completely blank screen when all options are disabled leads to poor UX.
