...
## 2024-06-23 - Empty State Visual Structure
**Learning:** In multi-select filter components (e.g., format toggles), leaving a completely blank screen when all options are disabled causes confusion.
**Action:** Always implement a visually structured empty state that includes a clear call-to-action button to provide an immediate path to recovery.
