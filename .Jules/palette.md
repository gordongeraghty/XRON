...
## 2024-05-24 - Structured Empty States for Multi-Select Filters
**Learning:** In multi-select filter components (e.g., format toggles), leaving a completely blank screen when all options are disabled leads to user confusion.
