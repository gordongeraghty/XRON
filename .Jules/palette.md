...
## 2024-07-21 - Structured Empty States in Multi-select Filters
**Learning:** In multi-select filter components (e.g., format toggles), leaving a completely blank screen when all options are disabled causes confusion and lacks a clear path to recovery.
