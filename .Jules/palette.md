...
## 2024-07-14 - Empty States for Multi-Select Toggles
**Learning:** In multi-select filter components (e.g., format toggles), leaving a completely blank screen or generic text when all options are disabled causes user confusion and poor recovery paths.
