...
## 2026-07-18 - Empty State Recovery Pattern
**Learning:** In multi-select filter components (e.g., format toggles), leaving a completely blank screen when all options are disabled leads to a dead end and a poor user experience. Users need an immediate, obvious path to recover the default state.
