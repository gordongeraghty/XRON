...
## 2024-06-28 - Empty States Without Actionable Recovery Paths
**Learning:** The multi-select filter components (e.g., format toggles) left a completely blank screen when all options were disabled, resulting in a poor empty state.
