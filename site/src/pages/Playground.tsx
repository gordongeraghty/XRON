  ...
  return (
    <main className="max-w-screen-xl mx-auto px-4 py-8">
      ...
      {activeFormats.length === 0 ? (
        <div className="text-center py-16 text-gray-400 dark:text-gray-600 text-sm flex flex-col items-center justify-center gap-3">
          <p>Select at least one format above to compare.</p>
          <button
            onClick={() => setActiveFormats(DEFAULT_ACTIVE)}
            className="px-4 py-2 bg-violet-100 dark:bg-violet-900/40 text-violet-700 dark:text-violet-300 rounded-lg hover:bg-violet-200 dark:hover:bg-violet-900/60 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 font-medium"
          >
            Reset to defaults
          </button>
        </div>
