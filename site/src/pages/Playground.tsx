  ...
  return (
    <main className="max-w-screen-xl mx-auto px-4 py-8">
      ...
      {activeFormats.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 px-4 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-dashed border-gray-200 dark:border-gray-800 mb-8">
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">
            Select at least one format above to compare.
          </p>
          <button
            onClick={() => setActiveFormats(DEFAULT_ACTIVE)}
            className="px-4 py-2 text-sm font-medium text-violet-600 dark:text-violet-400 bg-violet-100 dark:bg-violet-900/30 hover:bg-violet-200 dark:hover:bg-violet-900/50 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500"
