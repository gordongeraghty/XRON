  ...
  return (
    <main className="max-w-screen-xl mx-auto px-4 py-8">
      ...
      {activeFormats.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-xl bg-gray-50 dark:bg-gray-900/50">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4 max-w-sm">
            Select at least one format above to compare token usage, or reset to the default comparison set.
          </p>
          <button
