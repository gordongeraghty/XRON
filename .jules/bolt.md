...
## 2024-07-12 - [Text Substitution Performance]
**Learning:** In hot text substitution paths (like dictionary expansion), using `String.prototype.replace` with RegEx causes massive garbage collection and is ~4x slower.
**Action:** Use imperative substring scanning with manual `charCodeAt` checks and careful string concatenation to significantly improve string parsing performance in V8.
